                    ...
                    child: Stack(
                      children: [
                        Column(
                          ...
                          children: <Widget>[
                            ...
                            ListTile(
                              title: Text(
                                "Selamat Datang!",
                                style: TextStyle(fontSize: 21.0, color: Color.fromARGB(
                                    255, 154, 191, 21), fontWeight:FontWeight.w900, fontFamily: "Poppins",),
                              ),
                              subtitle: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  ...
                                  RichText(
                                    text: const TextSpan(
                                      style:
                                      TextStyle(fontSize: 15.0, color: Color.fromARGB(
                                          255, 154, 191, 21)),
                                      children: <TextSpan>[
                                        TextSpan(
                                  ...
                                  ElevatedButton(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsets.only(left: 10, right: 10), // Adjust the padding values as per your preference
                                      child: Text(
                                        'Cari Pengepul',
                                        style: TextStyle(
                                          fontFamily: "Poppins",
                        ...
                        Positioned(
                          ...
                          right: -65,
                          child: Image.asset(
                            'assets/images/homeb.png', // change this to your image path
                        ...
                        Positioned(
                          ...
                          right: 27,
                          child: Image.asset(
                            'assets/images/homep.png', // change this to your image path
                            width: 65, // set the width and height of the imag
                          ),
                        ),
                      ],
                    ),
