...
import 'package:proto/view_youtube.dart';
...
class topikList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 07,
        title: const Text("Topik", style: TextStyle(fontWeight: FontWeight.bold,color:Color.fromARGB(255, 154, 191, 21), fontFamily: "Poppins",),),
        centerTitle: true,
        ...
        child: SafeArea(
          child: Column(
            children: [
              ...
              // isi dari Card
              TopikWidget(topik: 'Waste Management',),
              TopikWidget(topik: 'Jenis Sampah',),
              TopikWidget(topik: 'Topik Pengolahan Sampah',),
              TopikWidget(topik: 'Prinsip Pengolahan Sampah',),
            ],
          ),
        ),
      ),
...
class TopikWidget extends StatelessWidget {
  final String topik;

  const TopikWidget({
    super.key, required this.topik,
  });
      ...
      child: Card(
        ...
        child: Column(
          ...
          children: <Widget>[
            SizedBox(height: 10),
            ListTile(
              title: Text(topik , style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold, fontFamily: "Poppins",)),
              subtitle: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  SizedBox(height: 10),
              ...
              children: <Widget>[
                ...
                ElevatedButton(
                  ...
                  onPressed: (){
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => ViewYoutube()),
                    );
                  },
                  child: const Padding(
